...
public class CustomersController : ControllerBase
{
 ...
 [HttpGet][Authorize(Policy="ServiceAdvisor")] public async Task<ActionResult<IEnumerable<CustomerResponse>>> GetCustomers()=>Ok((await _db.Customers.AsNoTracking().Include(c=>c.Vehicles).ToListAsync()).Select(Map));
