...
`;
    ...
    sendEstimate?.addEventListener(
        ...
        () => {
            ...
            createApprovalSimulationPanel();

        }
    );


    function createApprovalSimulationPanel() {

        let approvalPanel =
            document.getElementById(
                "estimateApprovalDemo"
            );
        ...
        approvalPanel.innerHTML = `
            ...
            >
                ...
                <span
                    ...
                    "
                >
                    In the real system this response will come
                    from the Customer Portal through the backend.
                </span>

                <button
                    type="button"
                    id="simulateCustomerApproval"
                    class="sd-primary-button"
                >
    ...
    finalizeInvoice?.addEventListener(
        ...
        () => {
            ...
            invoiceMessage.textContent =
                `Invoice finalized successfully for ${formatLKR(currentEstimate.total)}.`;
