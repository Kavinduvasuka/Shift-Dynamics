document.addEventListener(
    ...
    () => {
        ...
        const pauseJobButton =
            document.getElementById("pauseJobButton");
...
document.addEventListener("DOMContentLoaded", () => {
    ...
    /* =====================================================
       MECHANIC - COMPLETED JOBS
       Demo frontend records.
       Backend will later supply actual completed jobs.
       ===================================================== */
    ...
    const completedJobsList =
        document.getElementById("completedJobsList");

    const completedJobSearch =
        document.getElementById("completedJobSearch");

    const completedJobFilter =
        document.getElementById("completedJobFilter");

    const completedJobsEmpty =
        document.getElementById("completedJobsEmpty");

    const completedJobModal =
        document.getElementById("completedJobModal");
